...
class InputsConfig:
    ...
    if model==3:
        ...
        ''' Node Parameters '''
        Nn = 18 # the total number of nodes in the network
        NODES = []
        from Models.Trias.Node import Node
        NODES = [
            Node(id=0,hashPower=12), 
            Node(id=1,hashPower=12), 
            Node(id=2,hashPower=11),
            
            Node(id=3,hashPower=5), 
            Node(id=4,hashPower=5),
            Node(id=5,hashPower=5), 
            Node(id=6,hashPower=5),
            Node(id=7,hashPower=5), 
            
            Node(id=8,hashPower=5),
            Node(id=9,hashPower=5),
            Node(id=10,hashPower=5),
            Node(id=11,hashPower=5),
            Node(id=12,hashPower=5),
            
            Node(id=13,hashPower=5),
            Node(id=14,hashPower=5),
            Node(id=15,hashPower=5),
            Node(id=16,hashPower=5),
            Node(id=17,hashPower=5)
